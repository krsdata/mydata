(function (h) {
    var n = function (d, n) {
        ...
        e = b.append('<div class="fpd-product-selection"><span><center><strong>Change Your Product</strong><br><br></center></span><a href="#" class="fpd-scroll-up ui-state-default"><span class="ui-icon ui-icon-carat-1-nn"></span></a><div><ul></ul></div><a href="#" class="fpd-scroll-down ui-state-default"><span class="ui-icon ui-icon-carat-1-ss"></span></a></div>').children(".fpd-product-selection").find("ul");
        m = b.append('<div class="fpd-product-container"><div id="main_canvas"><div class="fpd-toolbar"></div><div class="fpd-products"></div><div class="fpd-saved-products"><ul></ul></div></div><section class="fpd-clearfix"></section></div>').children(".fpd-product-container").children("div");
        ...
        this.addDesign = function (j, u, a) {
          ...
          // console.log('j = '+j+' u = '+u+' a = '+a.toSource());
            null == I && (I = b.append('<div class="fpd-design-selection"><span><select name="changedesign" id="changedesign" ><option value="">Select Category</option></select></span><a href="#" class="fpd-scroll-up ui-state-default"><span class="ui-icon ui-icon-carat-1-nn"></span></a><div><ul class="fpd-clearfix"></ul></div><a href="#" class="fpd-scroll-down ui-state-default"><span class="ui-icon ui-icon-carat-1-ss"></span></a></div>').children(".fpd-design-selection").find("ul"));
