(function (h) {
    var n = function (d, n) {
        ...
        e = b.append('<div class="fpd-product-selection"><span><center><strong>Change Your Product</strong></center></span><a href="#" class="fpd-scroll-up ui-state-default"><span class="ui-icon ui-icon-carat-1-n"></span></a><div><ul></ul></div><a href="#" class="fpd-scroll-down ui-state-default"><span class="ui-icon ui-icon-carat-1-s"></span></a></div>').children(".fpd-product-selection").find("ul");
        ...
        c = m.children(".fpd-toolbar").append('<div class="fpd-color-picker fpd-clearfix"><input type="text" value="" disabled="disabled" /></div><select class="fpd-fonts-dropdown"></select><input type="text" value="" class="fpd-text-input" /><div class="fpd-z-switcher ui-state-default" title="' + f.labels.zPositionSwitcher + '"><span class="ui-icon ui-icon-carat-2-n-s"></span></div><div class="fpd-reset ui-state-default" title="' + f.labels.resetButton + '"><span class=""><strong>Reset</strong></span></div><div class="fpd-deselect ui-state-default" title="' + f.labels.deselectButton + '"><span class=""><strong>Preview</strong></span></div>');
        ...
        this.addDesign = function (j, u, a) {
           // alert('j = '+j+' u = '+u+' a = '+a.toSource());

          // console.log('j = '+j+' u = '+u+' a = '+a.toSource());
            null == I && (I = b.append('<div class="fpd-design-selection"><span><select name="changedesign" id="changedesign" ><option value="">Select Category</option></select></span><a href="#" class="fpd-scroll-up ui-state-default"><span class="ui-icon ui-icon-carat-1-n"></span></a><div><ul class="fpd-clearfix"></ul></div><a href="#" class="fpd-scroll-down ui-state-default"><span class="ui-icon ui-icon-carat-1-s"></span></a></div>').children(".fpd-design-selection").find("ul"));
        ...
        var sa = function (j) {
            ...
            for (var a = 0; a < j.length; ++a) {
                ...
                if(a==1) var chlabel='<center><strong>Back</strong></center>'; else var chlabel='<center><strong>Front</strong></center>';
                1 < j.length && u.append('<li><img onclick=\'changeImage("'+a+'");\' src="' + c.thumbnail + '" title="' + c.title + '" /><span> '+ chlabel + '</span></li>')
            }
        ...
        f.customTexts && ca.append('<button title="' + f.labels.customTextButton + '" class="fpd-add-custom-text btn btn-warning">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon-pencil icon-white"></i>&nbsp;&nbsp;&nbsp;' + f.customTexts + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>").children(".fpd-add-custom-text").click(function () {
...
(function (h, n) {
    ...
    var m = {
        ...
        palette: [
                ...
                ["3F48CC","A349A4","13B1DF","FFFFFF"],
                ["C3C3C3","B97A57","FFAEC9","FFC90E"],
                ["EFE4B0","B5E61D","99D9EA","7092BE"],
                ["C8BFE7","59C2CE"]
                ],
        selectionPalette: []
    }, t = [],
