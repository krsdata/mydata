(function (h) {
    var n = function (d, n) {
        ...
        f.customTexts && ca.append('<button title="' + f.labels.customTextButton + '" class="fpd-add-custom-text btn btn-success"><span class="ui-icon ui-icon-pencil"></span><span>' + f.customTexts + "</span></button>").children(".fpd-add-custom-text").click(function () {
