 ...
 <script type="text/javascript">
  ...
  window.fbAsyncInit = function() {
    ...
    <?php if ($this->uri->segment(2) == 'signup'): ?>
      FB.init({
          appId      :'<?php echo FB_APP_ID; ?>',//'576108949145427',
  ...
  $('#facebook-signup').click(function(e){    
      ...
      //   alert(response.email);
        $.post('<?php echo base_url() ?>store/facebook_ajax',{firstname:response.first_name, lastname:response.last_name, email:response.email}, function(data){
          parent.location ='<?php echo base_url() ?>store/signup_form/';
...
<?php endif; ?>
        ...
        jQuery('.chg_coupon_code1').click(function(){
          ...
          function twtshare(id){
            window.open ("http://twitter.com/share?text=Here’s an awesome design&url=<?php echo base_url(); ?>store/twtshare/"+id+"&hashtags=peter,is,awesome","Twitter_Share","menubar=1,resizable=1,width=900,height=500");
          }

           function gplus_share(id){
            window.open ("https://plus.google.com/share?url=<?php echo base_url(); ?>store/gplus_share/"+id,"Google_Plus_Share","menubar=1,resizable=1,width=900,height=500");
          }

          function pinit_share(id,image,desc){

            window.open ("http://pinterest.com/pin/create/button/?url=<?php echo base_url(); ?>store/pinit_share/"+id+"&media=<?php echo base_url(); ?>assets/uploads/designs/thumbnail/"+image+"&description="+desc,"Pintrest_Share","menubar=1,resizable=1,width=900,height=500");
          }

          function tumbler_share(id,title,desc){
            window.open ("http://www.tumblr.com/share/link?url="+id+"&name="+title+"&description="+desc,"Tumbler_Share","menubar=1,resizable=1,width=900,height=500");
          }

           function stumbleupon(id,title){
            window.open ("http://www.stumbleupon.com/submit?url="+id+"&title="+title+"#sthash.qfm4JNv3.dpuf","Stumbleupon","menubar=1,resizable=1,width=900,height=500");
          }
        </script>
  ...
  <!-- share strip on homepage -->
    ...
    <script type="text/javascript" src="http://s.sharethis.com/loader.js"></script>
        <script type="text/javascript">stLight.options({publisher: "a6d59bb4-0e0a-4b6c-88f1-720509e46891", servicePopup:true, doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
<script>
...
var st_hover_widget = new sharethis.widgets.hoverbuttons(options);
  ...
  <?php endif ?>
   ...
   <?php if($this->uri->segment(1)=='wear_it' && !empty($design->design_video)): ?>
