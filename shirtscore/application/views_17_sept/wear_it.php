    ...
    <div class="span12">
      <div class="span4">
        ...
        <h4>More Available Products</h4>
              ...
              <div class="viewport" id="scroll" style="width:633px; height:165px; overflow-x:scroll">
                <ul class="overview">
               <?php
          ...
          <?php }  } ?>
           ...
           <div class="span6">
             <?php if(!empty($design->design_video)): ?>
              <h4 style="color:#3b5998"> Message</h4>
              
                  <?php if(!empty($design->design_video)): ?><a class="fancybox-media1" href="<?php echo $design->design_video; ?>"> <?php echo get_youtube_thumbnail($design->design_video);?> </a> <?php endif; ?> 
