    ...
    <div class="dashbox">
      ...
      <?php } ?>
          <h4>Purchase History</h4>
              <table width="78%" border="0" cellpadding="5px">
                  ...
                  <?php if ($orders): ?>
                      <?php $total_cost = 0.00; foreach ($orders as $row): ?>
                        <tr>
                          ...
                          <td>
                            <div class="btn-group"> 
                              <a href="<?php echo base_url() ?>user/order_info/<?php echo $row->id; ?>" class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="See Order Info"><i class="icon-eye-open"></i></a>
                            </div>
                          </td>
                        </tr>
                      <?php endforeach ?>
                  ...
                  <?php else: ?>
                      <tr>
                        ...
                        <td colspan="5" rowspan="4" style="text-align:center"><b>No Records Found</b></td>
                      </tr>
                  <?php endif ?>
              </table>
    </div>
