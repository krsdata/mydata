        ...
        <div class="dashbox">
          <h2>Edit Design</h2>
              ...
              <div class="well clearfix">
                  <div class="row-fluid">
                   <div class="span3">
                      <img style="float:left; margin:5px 25px 120px 0;" src="<?php echo base_url() ?>assets/uploads/designs/thumbnail/<?php echo $design->design_image; ?>" /> </br></br>
                   </div>
                   <div class="span6">
                      <strong>The Artist:</strong><br />
                      <span style="color:red"><?php echo form_error('artist'); ?> </span>
                      <input type="text" name="artist" size="50" value="<?php echo $design->artist; ?>" /> <br /><br />
                      <strong>Design Title</strong><br />
                      <span style="color:red"><?php echo form_error('design_title'); ?> </span>
                      <input type="text" name="design_title" id="title" size="50" value="<?php echo $design->design_title; ?>" /><br /><br />
                      ...
                      <input type="radio" name="design_video_type" id="video_url" value="1" <?php if($design->design_video_type=='1') echo 'checked="checked"'; ?>/>
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                   <strong>Upload your video about design</strong>&nbsp;&nbsp;&nbsp;
                   <input type="radio" name="design_video_type" id="video_upload" value="2" <?php if($design->design_video_type=='2') echo 'checked="checked"'; ?>/><br /><br />

                  <span class="design_video" <?php if($design->design_video_type == '1'): echo 'style="display:block"'; else: echo 'style="display:none"'; endif; ?>>
                  ...
                  <span class="upload_video" <?php if($design->design_video_type=='2') echo 'style="display:block"'; else echo 'style="display:none"'; ?>>
                     ...
                     <?php if ($design->design_video_type=='2'): ?>
                      ...
                      <br/><br/>
                      <input class="btn-success btn update_cart" type="submit" name="submit" value="Update Design" />
