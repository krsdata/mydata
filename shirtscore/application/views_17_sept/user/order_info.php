...
<div class="dashcontent">
	<div class="dashbox">
     ...
     <div style="font-size:14px; color:#3B5998">
          <strong>Name of recipient:</strong> &nbsp;&nbsp;<span class="input-error"> <?php if(!empty($order_user_info->recipient_name)) echo $order_user_info->recipient_name; ?></span>
     </div>
     <br />
                ...
                <?php $i=1; foreach ($order_info as $row){
                     ...
                     ?>
                        <tr>
                         <td><?php echo $i; ?></td>
                          <td>
                            <img style="width:250px !important; float:left;" src="<?php echo $cart_detail->options->Path; if(!empty($cart_detail->options->Images)) echo $cart_detail->options->Images ; ?>">
                          </td>
                          <td>
                            <img style="width:250px !important; float:left;" src="<?php echo $cart_detail->options->Path; if(!empty($cart_detail->options->Back_Images)) echo $cart_detail->options->Back_Images ; ?>">
                          </td>
