  ...
  <div class="span9" >
      ...
      <div class="span3">
           ...
           <div class="api-buttons clearfix pull-right">
               ...
               <!--  <a href="#" id="upload-button" class="btn btn-warning">Upload Your Own Design</a>  -->
                <a href="#" id="image-button" data-original-title="Please select front view of product then proceed." class="btn btn-success">ADD TO CART</a> &nbsp;&nbsp;
...
jQuery(element).find('img,p').trigger('click');
  ...
  if(jQuery(element).attr('title')=='Enter your text here'){
  $('#fpd').find('.fpd-text-input').focus();
}
...
//////////////////////////
      ...
      $('#fpd').bind('imageCreate', function(evt, canvas, base64Image) {
        ...
        if(confirm('Are you sure want add to Basket?') == false) return false;
  ...
  <div class="fpd-design">
    ...
    <div style=" position: relative;">
      <div  id="color_boxes">
        ...
        <div class="row"><span>Select Your Product Color</span></div>
      </div>
    </div>
