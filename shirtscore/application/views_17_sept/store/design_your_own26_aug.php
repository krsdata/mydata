...
<?php } ?>
  ...
  <div class="row-fluid" >
          ...
          <span class="span5" style="color: #51A351; font-size: 24px;font-weight: bold;">DESIGN YOUR OWN SHIRT!</span>
           ...
           <div class="api-buttons clearfix pull-right" style="margin-bottom:-20px">
                       
                <div class="price" style="padding:8px; min-width:30px;color: #3b5998">PRICE:&nbsp;&nbsp;<span class="shirt-price"><?php echo money_symbol(); ?></span><span id="thsirt-price" class="shirt-price"></span>
                 </div>
...
<div class="row-fluid" >
 ...
 <span class="pull-right"><button id="image-button" data-original-title="Please select front view of product then proceed." class="btn btn-success"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="icon-shopping-cart icon-white"></i> ADD TO CART&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button></span>
