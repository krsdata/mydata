      ...
      <div class="span6">
           ...
           <div class="api-buttons clearfix span12 pull-left">
              ...
              <?php echo form_close(); ?>
                ...
                <a href="#" id="image-button" data-original-title="Please select front view of product then proceed." class="btn btn-mini btn-success">Create & Submit</a>
...
<div id="fpd">   
  ...
  <div class="fpd-design">
        ...
        <?php if (!empty($design_slug)): ?>
          <img class="designs" id="design<?php echo $designs->id ?>" src="<?php echo base_url() ?>assets/uploads/designs/thumbnail/<?php echo $designs->design_image ?>" title="<?php echo $designs->design_title; ?>" price="<?php echo $designs->price ?>" data-parameters='{"x": 215, "y": 200,  "removable": true, "draggable": true, "rotatable":true, "resizable": true, "price": <?php echo $designs->price ?>,"design_id":<?php echo $designs->id ?>, "slug": 1 <?php if (!empty($boundingBox)){ ?>, "boundingBox" : <?php echo $box; } ?>}}' />
        <?php else: ?>
          <?php if (!empty($designs)): ?>
            <?php foreach ($designs as $row): ?>
              <img class="designs" id="design<?php echo $row->id ?>" src="<?php echo base_url() ?>assets/uploads/designs/thumbnail/<?php echo $row->design_image ?>" title="<?php echo $row->design_title; ?>" price="<?php echo $row->price ?>" data-parameters='{"x": 215, "y": 200,  "removable": true, "draggable": true, "rotatable":true, "resizable": true, "price": <?php echo $row->price ?>,"design_id":<?php echo $row->id ?>, "slug": 1 <?php if (!empty($boundingBox)){ ?>, "boundingBox" : <?php echo $box; } ?>}' />
            <?php endforeach ?>
          <?php endif; ?>
        <?php endif; ?>
  ...
  <div class="span11" id="color_boxes" >
    <?php echo $col_html; ?>
    <!-- </span></div> -->
  </div>
</div>
...
<input type="hidden" id="product_face" name="product_face" value="0" >
<input type="hidden" id="in_out" name="in_out" value="0" >
  <?php if (!empty($products)): ?>
  <!-- Printing Area  -->
