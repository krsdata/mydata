             ...
             <!--  <div><h2 align="center">Sign up with your Facebook account<br />so you can share your design!</h2></div> -->
              <div align="center">
               <!--  <div class="fb-login-button">
                ...
                <!-- <a href="javascript:void(0)" id="facebook-signup"  title=""><img src="<?php // echo base_url() ?>assets/front_theme/img/fb_login_icon.gif"></a> -->
                or
...
<script>
  ...
  //   FB.init({
  //     appId      : '576108949145427', //  ( http://ss.examine247.com/store/signup/ )
  ...
  //             type: "POST",
  //             data: { resp: response,},
  //             url: "<?php echo base_url() ?>store/ajax_fb_login",
  ...
  //               if(obj.status)
  //               {
  //                  window.location = "<?php echo base_url().'store/fb_info'; ?>";
  //               }
  //               else
  //               {
  //                 alert('Cannot login...');
