...
//if($row->position=='right')
          ...
          <?php //}  } ?>
           ...
           <div class="fb-comments" data-href="<?php echo current_url() ?>" data-numposts="5" data-colorscheme="light" data-width="400"></div>
         <?php endif; ?>
           ...
           <ul>
            ...
            <?php if(!empty($design->design_video)): ?>
              ...
              <div style="padding-right:20px">
                   <div class="fb-comments" data-href="<?php echo current_url() ?>" data-width="450" data-numposts="5" data-colorscheme="light">
                   </div>
              </div>
            <?php endif; ?>
           </div>
