 ...
 <button id="upload-button" class="btn btn-warning"> <i class="icon-upload icon-white"></i> Upload Your Own Design</button>
  ...
  jQuery(document).ready(function() {
      ...
      var fpd = jQuery('#fpd').fancyProductDesigner({
        ...
        customTextParamters: {x: (f_left+1), y: (f_top+1), colors: "#FFFFFF", removable: true, resizable: true, draggable: true, rotatable: false, price: 4, boundingBox:{x: f_left, y: f_top, width: f_width, height: f_height}}
      })
  ...
  <div class="fpd-design">
    ...
    <div style=" position: relative;">
      <div  id="color_boxes">
        ...
        <div class="row">
          <div class="span2">
          <span id="color_ajax_loader" style="display:none;">
          <img style="  margin: 10px;" src="<?php echo base_url() ?>assets/images/ajax-loader.gif" alt="Loader">
          </span>
          </div>
          <div class="span10">
