...
<div class="dashbox  dashcontent">
 ...
 <div class="dashbox dashcontent">
          ...
          <div class="">
            ...
            <div  class="span2">
              <a href="<?php echo base_url() ?>store/design_your_own/<?php echo $row->slug; ?>"><img class="span2" src="<?php echo base_url() ?>assets/uploads/designs/<?php echo $row->design_image; ?>" style="width:150px; height:125px"></a><br>
