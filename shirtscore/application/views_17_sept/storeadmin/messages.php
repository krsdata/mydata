            ...
            <!-- End .title -->            
              <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
                ...
                <tr class="query <?php echo $class ?>">
                  ...
                  <td><a href="<?php echo base_url() ?>storeadmin/read_message/<?php echo $row->id; ?>" class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="See Message"><i class="icon-eye-open"></i></a></td>
                  <td><a href="<?php echo base_url() ?>storeadmin/delete_message/<?php echo $row->id; ?>" onclick="return confirm('are you sure?');" class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="Delete"><i class="icon-remove"></i></a></td>
        			  </tr>                  
           <?php $i++; } } else { ?>
					<tr>
