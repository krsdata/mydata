       	...
       	<?php if($this->session->flashdata('success_msg')){ ?>
            ...
            <!-- End .title -->
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9"><textarea  id="editor1" name="note" rows="10" class="row-fluid"><?php if (set_value('note') != ''){echo set_value('note');}else{if (isset($order_note)) {echo $order_note->note;}} ?></textarea>                    
                  </div>
                </div>      
                <div class="form-row control-group row-fluid">
