        ...
        <div class="navbar header">
          <div class="navbar"  style=" margin-bottom: 0;">
            ...
            <div id="main_menu" class="nav-collapse collapse">
              ...
              <ul class="nav" style="top: 0px; float: right;">               
               ...
               <!--  <li><a href="<?php //echo base_url('store/designs');?>">Choose Design</a></li>
                  ...
                  <li>
                    <div class="fb-logo">
                      <a style="padding-top:5px;" id="fcbook" href="http://facebook.com"  target="_blank" >
         ...
         <div class="container">
            <div class="cart"><a style="margin-top:6px;" href="<?php echo base_url() ?>storeadmin/logout"><i class="icon-signout"></i> Logout</a></div>
            ...
            <div style="margin-bottom:4%; margin-left:1%;">
              <ul id="coolMenu" class="dashnav">
                <li><a class="menu" href="<?php echo base_url()?>storeadmin"><i class="icon-dashboard"></i> My Dashboard</a></li>

                <li><a href="javascript:void(0);" idno="div_1" class="m_menu menu"><i class="icon-home"></i> Manage Stores </a>
                  <ul id="div_1" class="noJS">
                    <li><a href="<?php echo base_url() ?>storeadmin/stores"> Stores </a></li>
                    <li><a href="<?php echo base_url() ?>storeadmin/add_Store"> Add Store </a></li>
                  </ul>
                </li>

                <li><a href="javascript:void(0);" idno="div_2" class="m_menu menu"><i class="icon-picture"></i> Manage Designs </a>
                  <ul id="div_2" class="noJS">
                    <li><a href="<?php echo base_url() ?>storeadmin/my_designs"> Designs </a></li>
                    <li><a href="<?php echo base_url() ?>storeadmin/add_design"> Add Design </a></li>
                  </ul>
                </li>

                <li><a class="menu" href="<?php echo base_url() ?>storeadmin/sales_report"><i class="icon-bar-chart"></i> Sales Reports </a></li>

                <!-- <li><a class="menu" href="<?php // echo base_url() ?>storeadmin/admin_profile"><i class="icon-user"></i> My Account </a></li> -->
                <li><a href="javascript:void(0);" idno="div_4" class="m_menu menu"><i class="icon-user"></i> My Account </a>
                  <ul id="div_4" class="noJS">
                    ...
                    <li><a href="<?php echo base_url() ?>storeadmin/admin_payee_profile"> Account Info </a></li>
                    <li><a href="<?php echo base_url() ?>storeadmin/orders"> My Purchases </a></li>
                  </ul>
                </li>

                <li><a href="javascript:void(0);" idno="div_3" class="m_menu menu"><i class="icon-question-sign"></i> Supports </a>
                  <ul id="div_3" class="noJS">
                    <li><a href="<?php echo base_url() ?>storeadmin/need_help"> Need help </a></li>
                    <li><a href="<?php echo base_url() ?>storeadmin/my_queries"> My Queries </a></li>
                    <li><a href="<?php echo base_url() ?>storeadmin/messages"> Messages </a></li>
                  </ul>
                </li>
              </ul>
          ...
          <!-- <hr color="3b5998" /> -->
            <div class="row-fluid">
              <!-- <div class="span3 store_main_span">
                <div class="well sidebar-nav" style="background-color: #FFFFFF;">
                </div>
              </div> -->
              <div class="dashbox">
          <style type="text/css">
