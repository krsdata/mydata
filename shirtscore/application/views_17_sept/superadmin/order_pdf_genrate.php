...
<img style="max-width:180px !important;" src="<?php echo $cart_detail->options->Path; if(!empty($cart_detail->options->Images)) echo $cart_detail->options->Images ; ?>">
<img style="max-width:180px !important;" src="<?php echo $cart_detail->options->Path; if(!empty($cart_detail->options->Back_Images)) echo $cart_detail->options->Back_Images ; ?>">
</td>
<td>
<table  border="0" cellspacing="0" cellspacing="0" style="border: 7mm solid aqua;	border-collapse: collapse;min-width: 220px;float: left;border: 1px solid rgb(162, 157, 157);padding: 10px;">
