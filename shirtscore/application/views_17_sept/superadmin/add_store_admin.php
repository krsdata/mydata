      ...
      <div class="row-fluid ">     	
        ...
        <div class="span12">
          ...
          <div class="box paint color_0">
            <div class="title">
              <h4> <i class=" icon-user-md"></i> <span> Add Store Admin </span> </h4>
            </div>
            <!-- End .title -->
 <!--  -->          
  <div class="content">
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" class="row-fluid" name="mobile" value="<?php echo set_value('mobile'); ?>" placeholder="Mobile no.">
                  </div>
                </div>     
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <select name="country" data-placeholder="Choose Country" class="chzn-select">
                     ...
                     <?php $country = get_country_array(); ?>
                      ...
                      <option <?php echo set_select('country', $key); ?> value="<?php echo $key ?>" <?php if(set_value('country')){ if(set_value('country') === $key) echo 'selected="selected"'; }?> ><?php echo $value ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                </div>
