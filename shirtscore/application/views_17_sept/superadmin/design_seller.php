        ...
        <?php  } ?>
         ...
         <div class="row-fluid ">       
          <div class="box paint color_0">         
            <div class="title">
              <h4> <i class=" icon-user-md"></i> <span>Design seller </span> </h4>
            </div>
            <!-- End .title -->
            <div class="content top">
              <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
                ...
                <tbody>
                <?php if($design_seller){ $i = $offset; foreach($design_seller as $row){ ?> 
                <tr>
          <td><?php echo $i ?></td>
         ...
         <!--  <td><a class="btn btn-info" href="<?php echo base_url() ?>superadmin/login_as_storeadmin/<?php echo $row->id; ?>" target="_blank">Login</a></td>   --> 
          <td>
            <?php if ($row->banned == 1){ ?>
            <a href="<?php echo base_url().'superadmin/design_seller_block/'.$row->id.'/0'; ?>" class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="unblock Admin"><i class="icon-unlock"></i></a>
            <!-- <a href="<?php //echo base_url().'superadmin/block_store_admins/'.$row->id.'/0'; ?>" title="unblock"><span class="label label-info">unblock</span></a> -->
            <?php }else{ ?>
            <a href="<?php echo base_url().'superadmin/design_seller_block/'.$row->id.'/1'; ?>" class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="Block Admin"><i class="icon-lock"></i></a>           
            <?php } ?>        
            
          <!-- </td>     
          <td> -->
            <div class="btn-group"> 
              <a href="<?php echo base_url() ?>superadmin/edit_design_seller/<?php echo $row->id; ?>" class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="Edit Store Admin"><i class="icon-edit"></i></a>
            </div>
          <!-- </td>
          <td> -->
            <div class="btn-group"> 
            <a href="<?php echo base_url() ?>superadmin/delete_design_seller/<?php echo $row->id; ?>" onclick="return confirm('are you sure?');" class="btn btn-small" rel="tooltip" data-placement="top" data-original-title="Delete Store Admin"><i class="icon-remove"></i></a>
            </div>
          </td>
        </tr>
          <?php $i++; } ?>
