            ...
            <div class="span6">
              <div class=" box color_2 height_medium paint_hover">
                <div class="content numbers">
                  ...
                  <h1 class="value"> <?php if($order_items) echo $order_items; else echo '0';?></h1>
                  <div class="description"><a href="<?php echo base_url().'superadmin/orders'; ?>" >Total Sold Items</a></div>
                </div>
              </div>
            </div>
            <!-- End .span6 -->
