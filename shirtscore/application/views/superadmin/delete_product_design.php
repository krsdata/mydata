		...
		<?php } ?>
          ...
          <div class="box paint color_0">       	
            ...
            <div class="title">
              ...
              <h4> <i class=" icon-user"></i> <span> Delete Product Designs </span> </h4>
            </div>
            <!-- End .title -->
            <div class="content top">
              ...
              <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
                ...
                <tr>
                  ...
                  <td><input type="checkbox" name="design[]" value="<?php echo $row->design_id;?>" class="check_1"></td>
        				</tr>
                <?php $i++; } ?>
                <tr>
                  <td colspan="7"><input name="delete_design" id="design_delete" type="submit" value="Delete" class="btn-info btn"></td>
                </tr> 
    ...
    #datatable_example tbody tr td a{
     ...
     $(document).ready(function() {
        $("#check_all").change(function(){
         ...
         $("#design_delete").click(function(e){
          var count_check = 0;
