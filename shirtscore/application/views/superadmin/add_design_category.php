      ...
      <div class="row-fluid ">     	
        ...
        <div class="span12">
          ...
          <div class="box paint color_0">
            <div class="title">
              <h4> <i class=" icon-user"></i> <span> Add Design Category </span> </h4>
            </div>
            <!-- End .title -->
 <!--  -->          
  <div class="content">
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" id="title" class="row-fluid" name="category" value="<?php echo set_value('category'); ?>" placeholder="Category Name">
                  </div>
                </div>
