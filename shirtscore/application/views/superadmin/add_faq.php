    ...
    <div class="row-fluid ">     	
        <div class="span12">
          ...
          <div class="box paint color_0">
            <div class="title">
              <h4> <i class=" icon-question-sign"></i> <span> Add FAQ </span> </h4>
            </div>
            <!-- End .title -->
 <!--  -->          
  <div class="content">
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" value="<?php echo set_value('question'); ?>" class="row-fluid" name="question" placeholder="Question">
                  </div>
                </div>               
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <textarea  id="editor1" name="answer" rows="10" class="row-fluid"><?php echo set_value('answer'); ?></textarea>                    
                  </div>
                </div>      
