<div id="main_container">
        ...
        <div class="row" style="margin-bottom:10px">
          <?php echo form_open('superadmin/old_orders', array('class'=>'form-horizontal row-fluid')); ?>  
              ...
              <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
                ...
                <tr>
                  ...
                  <td><?php echo(fetch_order_status($row->order_status)) ?></td>
					...
					<?php } ?>	
           <tr>
            <td colspan="7"><input type="submit" onclick="return confirm('are you sure?');" value="Delete" class="btn-info btn"></td>
          </tr>
