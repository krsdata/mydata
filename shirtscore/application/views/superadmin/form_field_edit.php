      ...
      <div class="row-fluid ">      
        ...
        <div class="span12">
          ...
          <div class="box paint color_0">
            <div class="title">
              <h4> <i class=" icon-user"></i> <span> Edit Form Field </span> </h4>
            </div>
            <!-- End .title -->
 <!--  -->          
  <div class="content">
          <?php echo form_open_multipart(current_url(),array('class'=>'form-horizontal row-fluid','id'=>'build_form')); ?>             
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" value="<?php echo $field->field_name; ?>" class="row-fluid span3" name="field_name" placeholder="Field Label">
                  </div>
                </div>
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                   <select name="field_type" class="span3">
                      <option value="" >Select Field Type</option>
                      <?php 
                      foreach ($type_array as $key => $value) 
                      {
                      ?>
                       <option class="f-type" value="<?php echo $key; ?>" <?php if($field->field_type == $key){echo 'selected="selected"';} ?> ><?php echo $value; ?></option>
                      <?php
                      }
                      ?>
                    </select>
                ...
                <div class="form-row control-group row-fluid" id="sel-optn" <?php echo $display ?>>
                  ...
                  <div class="controls span9">                   
                    <input type="text" class="row-fluid" name="option" value="<?php echo $field->extras; ?>" placeholder="Please enter options for select box seperated by ','(comma).">
                  </div>
                </div>    
                   <?php
                $attr_name = array();
                          ...
                          <label class="control-label" style="text-align:left !important" for="">Name</label>                 
                           ...
                           if ($count > 0)
                           {
                            $i=0;
                              ...
                              {
                           ?>
                                  <input type="text" name="attr_name[]" <?php if($i != 0){echo 'id="name'.$i.'"';} ?> value="<?php echo $name; ?>" style="margin-top:10px" class="row-fluid">
                           <?php
                               $i++;
                              }  
                           }
                           ...
                           {
                           ?>
                                  <input type="text" name="attr_name[]" value="" class="row-fluid">
                           <?php
                           }
                           ?>
                        ...
                        <div class="controls span3" id="attr_value">
                           ...
                           if ($count > 0)
                           {
                            $i=0;
                              ...
                              {
                           ?>
                                  <input type="text" name="attr_value[]" <?php if($i != 0){echo 'id="value'.$i.'"';}  ?> value="<?php echo $value; ?>" style="margin-top:10px" class="row-fluid">
                           <?php
                                $i++;
                              }  
                           }
                           ...
                           {
                           ?>
                                  <input type="text" name="attr_value[]" value="" class="row-fluid">
                           <?php
                           }
                           ?>
                ...
                <input type="hidden" name="count" id="count" value="<?php if($count != 0){ echo ($count-1);}else{echo $count;} ?>">
