      ...
      <div class="row-fluid ">     	
        ...
        <div class="span12">
          ...
          <div class="box paint color_0">
            <div class="title">
              <h4> <i class=" icon-user-md"></i> <span> Edit Customer Service </span> </h4>
            </div>
            <!-- End .title -->
            <!--  -->
          <div class="content">
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text"  class="row-fluid" name="firstname" value="<?php if(!empty($cust_service->firstname)) echo $cust_service->firstname; ?>" placeholder="First Name">
                  </div>
                </div>
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" class="row-fluid" name="lastname" value="<?php if(!empty($cust_service->lastname)) echo $cust_service->lastname; ?>" placeholder="Last Name">
                  </div>
                </div> 
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                        <span id="email_field"><input  type="text" class="row-fluid" name="email" value="<?php if(!empty($cust_service->email)) echo $cust_service->email; ?>" placeholder="Email"></span>
                  </div>
                </div>
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" class="row-fluid" name="phone" value="<?php if(!empty($cust_service->mobile)) echo $cust_service->mobile; ?>" placeholder="Mobile no.">
                  </div>
                </div>
                 ...
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <textarea name="address" rows="5" class="row-fluid"><?php if(!empty($cust_service->address)) echo $cust_service->address; else echo set_value('address'); ?></textarea>
                 ...
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" value="<?php if(!empty($cust_service->city)) echo $cust_service->city; else echo set_value('city'); ?>" class="row-fluid" name="city" placeholder="City">
                  </div>
                </div>
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" value="<?php if(!empty($cust_service->state)) echo $cust_service->state; else echo set_value('state'); ?>" class="row-fluid" name="state" placeholder="state">
                  </div>
                </div>
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text" class="row-fluid" name="zip" value="<?php if(!empty($cust_service->zip)) echo $cust_service->zip; else echo set_value('zip'); ?>" placeholder="Zip Code">
                  </div>
                </div>                
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <select name="country" data-placeholder="Choose Country" class="chzn-select">
                     ...
                     <?php $country = get_country_array(); ?>
                      ...
                      <option value="<?php echo $key ?>" <?php if($cust_service->country){ if($cust_service->country == $key) echo 'selected="selected"'; }?> ><?php echo $value; ?> </option>
                      <?php endforeach ?>
                    </select>
                  </div>
                </div>
