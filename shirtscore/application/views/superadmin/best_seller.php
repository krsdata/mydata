 <div id="main_container">    
         <div class="row-fluid ">       
          <div class="box paint color_0">         
            <div class="title">
              <h4> <i class=" icon-user-md"></i> <span>Best seller </span> &nbsp;&nbsp;&nbsp; <?php $product = get_best_selling_product(); if(!empty($product)){ if($product->status=='0'){ ?><a href="<?php echo base_url().'superadmin/update_best_selling/'.$product->status ?>" class="btn btn-success"  onclick="return confirm('do you want to Show product?');">Show Best Selling Product on Home page</a><?php }else{ ?><a href="<?php echo base_url().'superadmin/update_best_selling/'.$product->status ?>" class="btn btn-info" onclick="return confirm('do you want to Hide product?');">Hide Best Selling Product on Home page</a> <?php } } ?></h4>
            </div>
            <!-- End .title -->
