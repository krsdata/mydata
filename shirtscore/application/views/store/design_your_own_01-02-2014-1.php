...
<div class="dashbox">
  <div class="row-fluid">
      <div class="span6">
             ...
             <?php } ?>
           <div class="api-buttons clearfix span12 pull-left">
              ...
              <?php echo form_close(); ?>
               ...
               <!--  <a href="#" id="print-button" class="btn btn-mini btn-info">Print Preview</a> -->
                ...
                <a href="#" id="image-button" data-original-title="Please select front view of product then proceed." class="btn btn-success">Add To Basket</a> &nbsp;&nbsp;
               <!--  <input id="colorizable" type="checkbox"><a href="#" id="is_color" data-original-title="Check this box and upload your own design and uploaded file must be single color png image.">Colorizable?</a> -->
                <span class="price badge badge-inverse" style="padding:8px"><?php echo money_symbol(); ?><span id="thsirt-price"></span> </span>
              ...
              <!--   <textarea name="f_custom_img" style="display:none;"></textarea>
              <textarea name="b_custom_img" style="display:none;"></textarea>
               -->
        ...
        <div class="span6" >
          <span class="pull-right"><h2>Design Your Own</h2>
          </span>
        </div>
    </div>
  ...
  jQuery(document).ready(function() {
      ...
      var fpd = jQuery('#fpd').fancyProductDesigner({
        ...
        customTextParamters: {x: (f_left+1), y: (f_top+1), colors: "#000000", removable: true, resizable: true, draggable: true, rotatable: true, price: 3, boundingBox:{x: f_left, y: f_top, width: f_width, height: f_height}}
      })
        ...
        var pro_index = jQuery(this).index();
          jQuery.ajax({
              ...
              success: function(res){
                ...
                if(obj.status === 1){
                   jQuery('#color_boxes').html(obj.col);
       ...
       // console.log(' fcustomimg = '+e.toSource());
        ...
        if(window.FileReader) {
          ...
          var reader = new FileReader();
            ...
            if(upflag0==false){
              alert('Sorry!!! only one custom design allow on front side.');
         ...
         // console.log(jQuery('div.fpd-single-product:eq(1) div.fpd-element').html);
          ...
          if(upflag1==false){
            alert('Sorry!!! only one custom design allow on back side.');
...
<div id="fpd">   
  ...
  <div class="fpd-design">
        <?php if (!empty($products)): ?>
            ...
            ?>
        <?php endif; ?>
        <?php if (!empty($design_slug)): ?>
          <img class="designs" id="design<?php echo $designs->id ?>" src="<?php echo base_url() ?>assets/uploads/designs/thumbnail/<?php echo $designs->design_image ?>" title="<?php echo $designs->design_title; ?>" price="<?php echo $designs->price ?>" data-parameters='{"x": 215, "y": 200,  "removable": true, "draggable": true, "rotatable":true, "resizable": true, "price": <?php echo $designs->price ?>,"design_id":<?php echo $designs->id ?>, "slug": 1 <?php if (!empty($boundingBox)){ ?>, "boundingBox" : <?php echo $box; } ?>,"scale": 0.30}' />
        <?php else: ?>
...
<span  id="color_boxes"><?php echo $col_html; ?></span>
</div>
