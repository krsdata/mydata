...
<div class="container">
    ...
    <div class="span12">
      <div class="span4">
        ...
        <div id="scroll" style="width:700px;overflow-y:hidden;overflow-x:scroll; height:186px">
        <ul>
                ...
                <li>
                   <?php list($width, $height, $type, $attr) = getimagesize(base_url().'assets/uploads/products/thumbnail/'.$row->main_image);
                      ...
                      $h_f1=($height)/2.82;
                        ...
                        <img style=" max-width:32px;position: relative; left:<?php echo $w_f1 ?>px; top:<?php echo $h_f1?>px; z-index: 1;" src="<?php echo base_url() ?>assets/uploads/designs/thumbnail/<?php echo $design->design_image; ?>"/>
                        ...
                        <center><?php echo character_limiter($row->regular_name,10) ?></center>
                    </a>
                  </li>
          <?php }  } ?>
          </ul>
               ...
               <?php echo form_open_multipart(base_url().'store/create_product_design_multi/'.$this->uri->segment(2).'/'.$this->uri->segment(3)); ?>
                <div class="row-fluid">
                  ...
                  <?php $col=0; if ($colors): ?>  <br>                  
                     ...
                     <a href="javascript:void(0);"><div id="col_<?php echo $row->id;  ?>" class="color_select_multi" style=" float:left; margin-left:5px; background-color:<?php echo $row->color_code; ?>;" ></div></a>
                    <?php $col++; endforeach; ?>
                  <?php endif; ?>
                  </div> 
                  <div class="span12 "> 
                ...
                <?php if ($sizes): ?>
                  ...
                  <table>
                   ...
                   <td>
                      ...
                      <input class="inputfieldforquantity" min="1"  name="sizes_<?php echo $row1->id; ?>" type="number" value = "" placeholder="Quantity">
                    </td>
                <?php endforeach ?> 
                 </tr>
                  </table>               
                  <?php endif ?>
                   ...
                   <label class="labelclass"><?php echo $single_product->regular_name;?></label>          
