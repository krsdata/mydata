  ...
  <div class="viewport ">
    <div class="overview collapse">
      ...
      <ul id="sidebar_menu" class="navbar nav nav-list container full">
        ...
        <li class="accordion-group <?php echo $active_class; ?> color_7"> <a class="accordion-toggle widgets collapsed"  data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse2221"><img src="<?php echo THEME_URL ?>img/menu_icons/widgets.png"><span>Best seller section</span></a> 
            <ul id="collapse2221" class="accordion-body collapse <?php echo $open_class; ?>">
              <li><a href="<?php echo base_url() ?>superadmin/best_seller">best seller section</a></li>
        ...
        <?php if( $uri_segment=='coupons' || $uri_segment=='add_coupon' || $uri_segment=='edit_coupon' ) { $active_class='active'; $open_class='in';} else {$active_class=''; $open_class='';}  ?>    
          ...
          <?php if( $uri_segment=='supports' || $uri_segment=='faqs' || $uri_segment=='add_faq' || $uri_segment=='edit_faq' || $uri_segment=='supports_reply'|| $uri_segment=='customer_service' || $uri_segment=='add_customer_services' || $uri_segment=='edit_customer_services' || $uri_segment=='message_center' || $uri_segment=='messages' || $uri_segment=='message_info') { $active_class='active'; $open_class='in';} else {$active_class=''; $open_class='';}  ?>    
              <li class="accordion-group <?php echo $active_class; ?> color_7"> <a class="accordion-toggle widgets collapsed"   data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse6" ><img src="<?php echo THEME_URL ?>img/menu_icons/tables.png"><span>Support section</span></a> 
                <ul id="collapse6" class="accordion-body collapse <?php echo $open_class; ?>">
                  <li><a href="<?php echo base_url().'superadmin/supports'; ?>">support section</a></li>
                  <li><a href="<?php echo base_url().'superadmin/message_center'; ?>">sent messages</a></li>
