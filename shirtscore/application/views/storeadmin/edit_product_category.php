      ...
      <div class="dashcontent">
        <div class="dashbox">
       	...
       	<?php if($this->session->flashdata('success_msg')){ ?>
			...
			<?php } ?>
            <div class="title">
              <h4><span> Edit Product category </span> </h4>
            </div>
            <!-- End .title -->
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <input type="text"  class="row-fluid" name="category" value="<?php echo $product_categories->category_name; ?>" placeholder="Category Name">
                  </div>
                </div>                               
                <div class="form-row control-group row-fluid">
