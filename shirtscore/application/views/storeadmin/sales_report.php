                  ...
                  <tr>
                    ...
                    */ ?>
                        ...
                        ?>
                                ...
                                ?>
                                <tr>
                                  <td> <a class="btn" href="<?php echo base_url().'storeadmin/pay_request/'.customer_id(); ?>" onclick="return confirm('There will be a fee associated with payments on demand. <?php echo money_symbol().$mailed_check_fee; ?> for a mailed check and <?php echo money_symbol().$pay_pal_fee; ?> for pay pal transfer. Do u want to Continue?');"  > Pay Request </a>
                                </tr>
                        <?php
                               }
                        ?>
