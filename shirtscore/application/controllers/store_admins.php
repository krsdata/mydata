 <div id="main_container">    
    ...
    <div class="row" style="margin-bottom:10px">
          ...
          <div class="row">
             <input type="text" style="border:1px solid" id="search" name="fname" placeholder="First Name" >
             <input type="text" style="border:1px solid" name="lname" placeholder="Last Name" >
          </div> <br>
          <div class="row-fluid">
            <input type="text" class="span5" style="border:1px solid" name="email" placeholder=" Email Address" >
          </div><br>
          <div class="row-fluid">
            <input type="text" class="span5" style="border:1px solid" name="phone" placeholder=" Phone Number" >
          </div> <br>
          <div class="row-fluid">
            <input type="text" class="span5" style="border:1px solid" name="user_id" placeholder=" Member ID" >
          </div> <br>
          <div class="row">
          ...
          <div class="box paint color_0">         
            ...
            <div class="content top">
              <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
                ...
                <tbody>
                <?php if($store_admins){ $i = 1; foreach($store_admins as $row){ ?> 
                <tr>
          <td><?php echo $i ?></td>
