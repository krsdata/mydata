    ...
    <div class="container">
        ...
        <div class="row product_row2 margin_top_40">
            <div class="col-xs-12 col-sm-9 col-md-9">
                ...
                <div id="error_message"><?php  echo msg_alert_frontend(); ?></div>
                <div class="row">
                                ...
                                <div class="pro_contain text-center">
                                    <div class="pro_main">
                                        ...
                                        <div class="pro_info">
                                            ...
                                            <p class="product_price"><?php if(!empty($price)) echo '$'.$price; ?></p> 
                                        </div>
                                    </div>
                                    <div class="pro_hover">
                                        <div class="pro_hover_wrapper">
                                            ...
                                            <div class="hover_links">
                                                <div>
                                                    <a href="<?php echo base_url('cart/add/'.$row->slug);?>" data-toggle="tooltip" data-placement="top" title="Add to Cart"><i class="fa fa-cart-plus"></i></a>
                                                </div>
                                                <div>
                                                    <a href="<?php echo base_url('product/view/'.$row->slug);?>" data-toggle="tooltip" data-placement="top" title="Quick View"><i class="fa fa-eye"></i></a>
                                                </div>
                                                <div>
                                                    <a onclick="add_to_favorites(<?php echo $row->id; ?>)" data-toggle="tooltip" data-placement="top" title="Add to Favorites" style="cursor: pointer;"><i class="fa fa-heart-o"></i></a>
                                                </div>
                                            </div>
                                        </div>                               
                                    </div>
