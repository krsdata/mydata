	...
	<div class="container containBackWhite top_buffer_60 bottom_buffer_60">
		...
		<div class="row rowContent">
			<div class="col-xs-12 col-sm-6 col-md-6">
				...
				<form role="form" action="" method="post" name="login_form" class="top_buffer_20 login_form">
			  		...
			  		<a href="<?php echo base_url('website/forget_password')?>" class="pull-right forgot_pw_link"><i>Forgot Password</i></a>
				</form>				
			</div>
			<div class="col-xs-12 col-sm-6 col-md-6">
