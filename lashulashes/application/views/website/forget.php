  ...
  <div class="container containBackWhite top_buffer_60 bottom_buffer_60">
    ...
    <div class="row rowContent">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6">
        ...
        <form role="form" action="<?php echo base_url('website/forget_password')?>" method="post" name="fpassword_form">
            ...
            <a href="<?php echo base_url('website/login')?>" class="pull-left forgot_pw_link"><i>Login</i></a>
            </div>
        </form>       
      </div>
      <div class="col-xs-12 col-sm-6 col-md-6">
