      ...
      <div id="project" style="min-height: 230px; width:100%">
        <div style="font-size:14px;">
                      ...
                      <tbody>
                        ...
                        <?php if(!empty($order_order_detail)) { ?>
                            <?php foreach ($order_order_detail as $items): ?>
                                <tr>
                                    <td align="left" style="border-right:1px solid #B5C3DD;">
                                      <label><b>Artist : </b> <?php echo $items->artist_name; ?></label>
                                      <br/>
                                      <label><b>Treatment Type : </b> <?php if(isset($items->service_name)&&!empty($items->service_name)){ echo $items->service_name.' - '; } ?><?php echo $items->name; ?></label>
                                      <p style="margin: 0px;">
          ...
          <?php } if(!empty($type) && ($type == 'product')) { ?>
              ...
              <?php $order_user_detail = json_decode($value->user_detail); ?>
                <div style="padding-left: 1%;">
                    ...
                    <div style="width:32%; padding: 2px; float:left;">
                        ...
                        <p> 
                          Order Id : <?php echo $value->unique_order_id; ?><br>
                          Order Status : <?php if($value->status == 0 ) echo "Pending"; ?><br>
                          Date : <?php echo date('d, M Y h:i:s',strtotime($value->created)); ?>  <br>
                          Amount : <?php echo '$'.$this->cart->format_number($value->grand_total); ?> <br>
                          <?php echo str_replace('-',':', $value->coupon_code); ?>            
                        </p>
                    </div>
                ...
                <div>
                    ...
                    <div style="width:100%">
                      <table>
                        <thead>
                            <tr style="border-top: 1px solid #B5C3DD;">
                                <td width="40%" align="center" style="border-right: 1px solid #B5C3DD;"><b>Item</b></td>
                                ...
                                <td width="15%" align="center" style="border-right: 1px solid #B5C3DD;"><b>Subtotal</b></td>
                                <?php 
                                $discount_type = 2;
                                if($value->membership_discount_array!=''){
                                  $discount_type = 1;
                                }
                                ...
                                if($discount_type==1){  
                                   $colspan = 5;
                                ?>
                                <td width="12%" align="center" style="border-right: 1px solid #B5C3DD;"><b>(-)Discount</b></td>
                                <td width="12%" align="center" ><b>Final</b></td>
                                <?php } ?>
                            </tr>
                        </thead>
                        <tbody>
                          <?php 
                            $discountArr = json_decode($value->membership_discount_array,TRUE) ;
                            ...
                            <?php foreach ($order_order_detail as $items): ?>
                                <tr>
                                    ...
                                    <td align="right" style="vertical-align: middle; <?php if(count($discountArr)>0){ echo 'border-right: 1px solid #B5C3DD;';} ?>">$<?php echo $this->cart->format_number($items->subtotal); ?>
                                    </td>
                                    <?php  if($discount_type==1 && count($discountArr)>0){ 
                                              $item_subtotal = $items->price*$items->qty;
                                      ?>
                                   
                                    <td align="right" style="vertical-align: middle; border-right: 1px solid #B5C3DD;">$<?php echo $this->cart->format_number($discountArr[$items->id]); ?>
                                    </td>
                                     <td align="right" style="vertical-align: middle;">
                                      <?php echo '$'.$this->cart->format_number(($item_subtotal - $discountArr[$items->id]));; ?>
                                    </td>
                                    <?php } ?>
                                </tr>
                            <?php endforeach; ?>
                            <tr>
                              <td colspan="3" align="right" style="border-right: 1px solid #B5C3DD;"> <b>Total :</b></td>
                              <td align="right" <?php if($discount_type==1){ ?>style="border-right: 1px solid #B5C3DD;"<?php } ?> > <?php echo '$'.$this->cart->format_number($value->total); ?></td>
                               <?php  if($discount_type==1){ ?>
                               <td align="right" style="border-right: 1px solid #B5C3DD;" > <?php echo '$'.$this->cart->format_number($value->discount*(-1)); ?></td>
                               <td align="right"> <?php echo '$'.$this->cart->format_number(($value->total+$value->discount)); ?></td>
                                 <?php } ?>
                            </tr>
                            <?php if($value->tax>0) { ?>
                            <tr>
                              <td colspan="<?php echo $colspan; ?>" align="right" style="border-right: 1px solid #B5C3DD;"> <b>(+)GST (Goods & Services Tax) :</b></td>
                              <td align="right"> <?php echo '$'.$this->cart->format_number($value->tax); ?></td>
                            </tr>
                            <?php } ?>
                            <?php if($value->shipping>0) { ?>
                            <tr>
                              <td colspan="<?php echo $colspan; ?>" align="right" style="border-right: 1px solid #B5C3DD;"> <b>(+)Shipping :</b></td>
                              <td align="right"> <?php echo '$'.$this->cart->format_number($value->shipping); ?></td>
                            </tr>
                            <?php } ?>
                            <?php if($value->discount<0) { ?>
                            <tr>
                              <td colspan="<?php echo $colspan; ?>" align="right" style="border-right: 1px solid #B5C3DD;"> <b>(-)Discount :</b></td>
                              <td align="right"> <?php echo '$'.$this->cart->format_number($value->discount*(-1)); ?></td>
                            </tr>
                            <?php } ?>
                            <tr>
                              <td colspan="<?php echo $colspan; ?>" align="right" style="border-right: 1px solid #B5C3DD;"> <b>Grand Total :</b></td>
                              <td align="right"> <?php echo '$'.$this->cart->format_number($value->grand_total); ?></td>
                            </tr>
                        </tbody>
                      </table>
           ...
           <?php  if(!empty($type) && ($type == 'membership')) { ?>
            <?php if(!empty($value)) { ?>
              <?php //$order_user_detail = json_decode($value->user_detail); ?>
                <div style="padding-left: 1%;">
                    <div style="width:32%; padding: 2px; float:left;">
                        <h5>Order Details<hr></h5>
                        <p> 
                          Order Id : <?php echo $value->membership_order_id; ?><br>
                          Order Status : <?php echo $value->payment_status; ?><br>
                          Date : <?php echo date('d, M Y h:i:s',strtotime($value->order_date)); ?>  <br>
                          Amount :<?php echo '$'.$this->cart->format_number($value->plan_amount); ?>              
                        </p>
                    </div>
                    <div style="clear:both"></div>
                </div>       
                                    ...
                                    <td style="border-right: 1px solid #B5C3DD;">
                                        <div>
                                            <div style="width:30%; float:left;">
                                                <span>
                                                    <?php 
                                                    $image_headers = @get_headers($value->image); 
                                                    if($image_headers[0] != 'HTTP/1.1 404 Not Found') { ?>
                                                    <img src="<?php echo site_url(); echo str_replace('./', '', $value->image);?>" width="100%">
                                                    <?php } else { ?>
                                                    &nbsp;
                                                    <?php }?>
                                                </span>
                                            ...
                                            <div style="width:70%;  float:left;">
                                                <br>
                                                <b>Name :</b> <?php echo $value->title; ?><br>
                                            </div>
                                        </div>
                                    </td>
                                    <td align="right" style="vertical-align: middle; border-right: 1px solid #B5C3DD;">
                                      <?php echo '$'.$this->cart->format_number($value->plan_amount); ?>
                                    </td>
                                    <td align="right" style="vertical-align: middle;">$<?php echo $this->cart->format_number($value->plan_amount); ?>
                                    </td>
                                </tr>
                          
                            <tr>
                              <td colspan="2" align="right" style="border-right: 1px solid #B5C3DD;"> <b>Total :</b></td>
                              <td align="right"> <?php echo '$'.$this->cart->format_number($value->plan_amount); ?></td>
                            </tr>
                            
                           
                           
                            <tr>
                              <td colspan="2" align="right" style="border-right: 1px solid #B5C3DD;"> <b>Grand Total :</b></td>
                              <td align="right"> <?php echo '$'.$this->cart->format_number($value->plan_amount); ?></td>
                            </tr>
                        </tbody>
                      </table>
