							...
							<form  method="post" action="" enctype="multipart/form-data" class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input value="<?php if(isset($update)) { echo $update[0]->client_name; } else {  echo set_value('client_name'); } ?>" name="client_name" type="text" placeholder="Enter Name" class="form-control">
                                     ...
                                     <div class="form-group">
										...
										<div class="col-md-9">
											<input value="<?php if(isset($update)) { echo $update[0]->location; } else { echo set_value('location'); }  ?>" name="location" type="text" placeholder="Enter Location" class="form-control">
								    ...
								    <div class="form-group">
				                     ...
				                     <div class="col-md-9">
				                       <textarea  class="tinymce_edittor0 form-control" cols="100" rows="10" maxlength="900" name="feedback" onkeyup="max_text_count(this);"><?php if(isset($update[0])) { echo $update[0]->feedback; } else { echo set_value('feedback'); }?></textarea>
								...
								<div class="form-actions">
									<div class="row">
										...
										<a href="<?php echo base_url('backend/testimonials/index/'.$offset); ?>"> <button  class="btn default" type="button">Cancel</button></a>
