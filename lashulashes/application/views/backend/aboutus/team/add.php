							...
							<form  method="post" action="" enctype="multipart/form-data" class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input value="<?php   echo set_value('title'); ?>" name="title" type="text" placeholder="Employee Name" class="form-control">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input value="<?php   echo set_value('post'); ?>" name="post" type="text" placeholder="Employee post" class="form-control">
								    ...
								    <div class="form-group">
					                     ...
					                     <div class="col-md-9">
					                       <textarea  class="tinymce_edittor0 form-control" cols="100" rows="10" maxlength="450" name="content" onkeyup="max_text_count(this);"  ><?php echo set_value('content'); ?></textarea>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">										
											...
											<a href="<?php echo base_url(); ?>backend/about/team"> <button  class="btn default" type="button">Cancel</button></a>                                     
										</div>
									</div>
								</div>
							</form>
