							...
							<form  method="post" action="" class="form-horizontal">
								<div class="form-body">
										...
										<div class="col-md-9">
                                            ...
                                            <select name="type" class="form-control">
										        ...
										        <?php if(!empty($faq_array)) { ?>
													...
													<option value="<?php echo $key; ?>" <?php if(isset($_POST['type'])) {if($_POST['type']== $key ){?> selected="selected" <?php }}?> ><?php echo $value; ?></option>
										            <?php }?>
												<?php } ?>							
											</select>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input value="<?php echo set_value('question');?>" name="question" type="text" placeholder="Enter question" class="form-control">
                                    ...
                                    <div class="form-group">
					                     ...
					                     <div class="col-md-9">
					                       <textarea  class="tinymce_edittor form-control" cols="100" rows="12" name="answer"><?php echo set_value('answer'); ?></textarea><?php echo form_error('answer'); ?>
					                     </div>
				                    </div>
								...
								<div class="form-actions">
									<div class="row">
										...
										<a href="<?php echo base_url(); ?>backend/faqs/index"> <button  class="btn default" type="button">Cancel</button></a>
