							...
							<form   enctype="multipart/form-data" method="post" action=""  class="form-horizontal">
								<div class="form-body">
								 ...
								 <div class="form-group">
										...
										<div class="col-md-9">
											<input value="<?php echo set_value('gallery_title');?>" name="gallery_title" type="text" placeholder="Enter title" class="form-control">
								...
								<div class="form-actions">
									<div class="row">
										...
										<a href="<?php echo base_url(); ?>backend/gallery/index"> <button  class="btn default" type="button">Cancel</button></a>
