							...
							<form  method="post" action=""  class="form-horizontal">
								...
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-9">
											<input value="<?php if(isset($update)) { echo $update[0]->category_name; }  ?>" name="category_name" type="text" placeholder="Enter category Name" class="form-control">
								...
								<div class="form-actions">
									<div class="row">
										...
										<a href="<?php echo base_url('backend/category/index/'.$offset); ?>"> <button  class="btn default" type="button">Cancel</button></a>
