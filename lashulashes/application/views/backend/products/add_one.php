									...
									<div class="form">
										<form  ng-controller="MyController" method="post" action="<?php echo base_url('backend/products/add_attributes/'.$product_id.'/'.$offset)?>" class="form-horizontal" onsubmit="return variation_submit()">
											<div class="form-body">
												...
												<div class="form-group">
													<div class="col-md-12">
														<label for="Services"> <b>Selected Attributes</b></label>
														<div class="well">
															<ul id="form_list_" class="form_list_">
																					...
																					{ 
																						...
																						{	?>
																							<li onclick="this.parentNode.removeChild(this);">
																								<input type="hidden" name="attributes[]" value="<?php echo $row->id;?>"  ><?php echo $row->attribute;?>
																							</li>
																						<?php } 
																					} 
																				}
													...
													<div class="col-md-12">
														<ladel><b>Select Attribute </b></ladel>
													</div>
													<div class="col-md-6">
														<select onchange="selectAttributes(this);" id="stories_service_ele" name="stories_service_ele" class="form-control" >
															<option value="">Select Your Attribute</option>
															<?php foreach ($all_attribute as $row) { ?>
																<?php if($row->count > 0) { ?>
																	<option value="<?php echo $row->id;?>"><?php echo $row->attribute;?></option>
																<?php } ?>
															<?php }?>
														</select>
													</div>
													...
													<script type="text/javascript">
														...
														function selectAttributes(select)
														{
															  ...
															  //var text2 = document.createTextNode("<i class='fa fa-times' aria-hidden='true'></i>");
															  //console.log(text2);
															  // var text2 = '{<i class="fa fa-times" aria-hidden="true"></i>}';
															  // text2 = JSON.stringify(text2);
															     //text = text+'<i class="fa fa-times" aria-hidden="true"></i>';
															  input.type = 'hidden';
															...
															<?php if(count($variation)>0) { $vc=0; ?>
																...
																<?php foreach ($variation as $key) { ?>
																	...
																	<div class="form-group" id="variation_row_<?php echo $vc ?>">
																		<div class="col-md-2">
																			Bar Code
																			<input type="text"  required="" name="bar_code_<?php echo $key->id; ?>" value="<?php if(!empty($key->bar_code) || ($key->bar_code == 0)) echo $key->bar_code; ?>" class="form-control" placeholder="Enter bar code">
																		</div>
								...
								<div role="tabpanel" class="tab-pane <?php echo $tab4; ?>" id="profile">
									...
									<div <?php echo $image_button_style;?>>
										...
										<div id="upload_status">
											<label class="text-info">( Image needs to be at least 450 x 400 pixels and maximum 1280 x 1280 pixels. and now you can add only <?php echo $upload_image_count ?> image.)</label>
										</div>
									</div>
