						...
						<form  method="post" action="" class="form-horizontal" enctype="multipart/form-data">
							<div class="form-body"> 
								...
								<div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                       <textarea  class="form-control" cols="100"  maxlength="400" rows="5" name="detail" onkeyup="max_text_count(this);"><?php if(!empty($detail->detail)) echo $detail->detail; ?></textarea>
							...
							<div class="form-actions">
								<div class="row">
									...
									<a href="<?php echo base_url('backend/services/categories/'.$offset); ?>"> <button  class="btn default" type="button">Cancel</button></a>
