						...
						<form  method="post" action="" class="form-horizontal" enctype="multipart/form-data">
							<div class="form-body"> 
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input  value="0" name="price_status" type="checkbox" <?php if($detail->price_status==0){ echo "checked"; }  ?> > <label>Will there be any further addition on the sub catgeory.</label>
									</div>
								</div>
							</div>
