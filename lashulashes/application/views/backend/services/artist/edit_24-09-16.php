							...
							<div class="form-body"> 
								...
								<div class="form-group">
									<section class="col-md-12">
									    <ul class="nav nav-tabs pull-left artistTab" role="tablist">
															...
															foreach ($categoryLevel1 as $key1 => $value1) 
																{ ?>
																	...
																	{ ?>
																		...
																		{ ?>
																			<?php if(in_array($value2->id, $categoryLevel3_index)) { ?>
																				<div class="col-md-12 cal_time_col">
																						...
																						if($value3->parent_id == $value2->id) { ?>
																							<ul>
																								...
																								<li>
														  											...
														  											<input value="<?php if($servicesCount > 0 && isset($services['categoryPrice_'.$value3->id])) echo $services['categoryPrice_'.$value3->id];?>" type="text" name="categoryPrice_<?php echo $value3->id;?>" class="" placeholder="Price">
													  											</li>
																								<li>
														  											<span class="artistAddOn"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
														  											<input value="<?php if($servicesCount > 0 && isset($services['categoryTime_'.$value3->id])) echo $services['categoryTime_'.$value3->id];?>" type="text" name=" categoryTime_<?php echo $value3->id;?>" class=" time24 maskTime24" placeholder="Timing" >
											  													</li>
											  													<?php 
																				...
																				{ 
																					if($value3->parent_id == $value1->id) { ?>
																						<ul>
																							...
																							<li>
																								<span class="artistAddOn"><i class="fa fa-usd" aria-hidden="true"></i></span>
													  											<input value="<?php if($servicesCount > 0 && isset($services['categoryPrice_'.$value3->id])) echo $services['categoryPrice_'.$value3->id];?>" type="text" name="categoryPrice_<?php echo $value3->id;?>" placeholder="Price">
												  											</li>
																							<li>
																								<span class="artistAddOn"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
													  											<input value="<?php if($servicesCount > 0 && isset($services['categoryTime_'.$value3->id])) echo $services['categoryTime_'.$value3->id];?>" type="text" name="categoryTime_<?php echo $value3->id;?>" class="time24 maskTime24" placeholder="Timing" >
											    	...
											    	<div class="col-md-12">
											    		<div class="table-responsive">
											    			<div class="col-md-12" style="padding: 0px 0px 10px !important;">
																<label id="offModalButton" class="col-md-1 btn green"> 
