			...
			<div class="col-md-12">
				...
				<div class="portlet box green">
					<div class="portlet-title">
						<div class="caption">
								<i class="fa fa-list"></i> Booked Training List
						</div>							
					</div>
					<div class="portlet-body">
						...
						<div class="table-responsive">
							<div class="col-md-12 well">
								<form action="<?php echo base_url('backend/orders/training'); ?>" method="get" accept-charset="utf-8">
									...
									<!-- <div class="form-group col-md-6"> -->
										...
										<a href="<?php echo base_url('backend/orders/training'); ?>" class="btn btn-danger"> Reset </a>
									<!-- </div> -->
								</form>
							</div>
